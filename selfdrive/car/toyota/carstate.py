...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.brakePressed = cp.vl["BRAKE_MODULE"]['BRAKE_PRESSED'] != 0  # this is only user
    ret.brakeLights = cp.vl["ESP_CONTROL"]['BRAKE_LIGHTS_ACC'] or cp.vl["BRAKE_MODULE2"]['BRAKE_PRESSED'] != 0 or ret.brakePressed
